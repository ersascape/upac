...
// Ported from SPD Flash Tool Source — crc16.c
// ============================================================================
...
std::string from_utf16(const char16_t* str, size_t max_len) {
    ...
    // Simple conversion: most PAC strings are ASCII-range anyway.
    // For full correctness we handle the BMP (U+0000..U+FFFF).
    std::string result;
    result.reserve(len);
